...
- `--output-csv`: 出力CSVファイルパス（デフォルト: tank_timeseries.csv）
- `--max-tanks`: 処理するタンク数（デフォルト: 全タンク）
...
```bash
# 全タンク処理
python gee.py --project your-project-id --verbose

# 特定のタンクのみ処理
python gee.py --project your-project-id --tanks shibushi_01 shibushi_02

# 更新モード（差分更新）
python gee.py --project your-project-id --update
```
